						...
						<table>
							...
							<tbody style="margin-top: 50px">
								...
								<tr class="row100 body">
									...
									<td class="cell100 column2">{{$met->price}}</td>
									<td class="cell100 column2">{{$met->description}}</td>
									...
									<td class="cell100 column4" style="margin-top: 50px">
                                        {{-- <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups"> --}}
                                            <div class="btn-group mr-2" role="group" aria-label="First group">
                                              <a href="{{ route('menu.edit', $met)}}" class="btn btn-warning btn-sm">Modifier</a>
                                              <a href="#" class="btn btn-danger btn-sm btn-delete">Supprimer</a>
                                              <form action="{{ route('menu.destroy', $met)}}" method="POST" class="delete-met">
                                                  @method('DELETE')
                                                  @csrf
                                              </form>
                                            </div>
